    ...
    <div class="panel-body">
		<form action="updateBoard.do" method="post">
			...
			<table class="table table-bordered">
				...
				<tr>
					<td>내용</td>
					<td><textarea rows="7" name="content" id="content" class="form-control">${vo.content}</textarea></td>
				</tr>
				<tr>
					<td>작성자</td>
					<td><input type="text" name="writer" id="writer" class="form-control" value="${vo.writer}" readonly/></td>
				</tr>
				<tr>
